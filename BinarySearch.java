 ...
 *
 * Note: only those numbers are shown on the scren that are not whitelisted (as per the allow-list)
 *
 *
...
public class BinarySearch {
    ...
    public static int indexOf(int[] a, int key) {
        ...
        while (lo <= hi) {
            ...
            int mid = lo + (hi - lo) / 2;
            StdOut.println(spaces+"["+String.valueOf(lo)+ ", " + String.valueOf(hi) + "]");
